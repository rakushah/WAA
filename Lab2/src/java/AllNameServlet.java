 ...
 * @author Owner
 */
@WebServlet(urlPatterns = {"/AllNameServlet"})
public class AllNameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HashMap<String,Person> listPerson=(HashMap<String,Person>) session.getValue("names");
           ...
           out.println("<style type=\"text/css\">");
            ...
            System.out.println("name Alllist is = "+listPerson.size());
